package ru.mirea.ushakovaps.cryptoloader;
...
import ru.mirea.ushakovaps.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity  implements
    ...
    public void onClickButton(View view) {
        ...
        byte[] enc = encryptMsg(text, key);

        Bundle bundle = new Bundle();
        bundle.putByteArray(MyLoader.ARG_WORD, enc);
